...
const output = resolve(__dirname, "../src/overlay/index.json")
...
async function start() {
  ...
  const { compileOverlayV2 } = await import("../src/overlay/vue2")
  ...
  const { compileOverlayV3 } = await import("../src/overlay/vue3")
