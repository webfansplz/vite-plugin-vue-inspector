...
export interface VitePluginInspectorOptions {
   ...
   */
  launchEditor?: 'appcode' | 'atom' | 'atom-beta' | 'brackets' | 'clion' | 'code' | 'code-insiders' | 'codium' | 'cursor' | 'emacs' | 'idea' | 'notepad++' | 'pycharm' | 'phpstorm' | 'rider' | 'rubymine' | 'sublime' | 'vim' | 'visualstudio' | 'webstorm' | 'zed' | string
